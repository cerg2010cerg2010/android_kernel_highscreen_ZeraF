...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
    ...
    YUV_INFO(GC2145MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2145MIPI_YUV,NULL), 
#endif

#if defined(HI258_MIPI_YUV)
    YUV_INFO(HI258MIPI_SENSOR_ID, SENSOR_DRVNAME_HI258_MIPI_YUV,NULL), 
#endif
    ...
    YUV_INFO(S5K5EAYX_YUV_GZ_SENSOR_ID, SENSOR_DRVNAME_S5K5EAYX_YUV_GZ,NULL), 
#endif

#if defined(AT2250_YUV)
    YUV_INFO(AT2250_SENSOR_ID, SENSOR_DRVNAME_AT2250_YUV, NULL),
#endif

#if defined(OV2685MIPI_YUV)
    YUV_INFO(OV2685MIPI_SENSOR_ID, SENSOR_DRVNAME_OV2685MIPI_YUV,NULL), 
#endif
