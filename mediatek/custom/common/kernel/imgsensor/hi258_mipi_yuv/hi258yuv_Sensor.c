...
kal_uint32 HI258_PV_dummy_pixels=616,HI258_PV_dummy_lines=20,HI258_isp_master_clock=240/*0*/;
...
static kal_uint32  HI258_sensor_pclk=240;//520 //20110518
...
HI258_write_cmos_sensor(0x90, 0x0e); //BLC_TIME_TH_ON
HI258_write_cmos_sensor(0x91, 0x0e); //BLC_TIME_TH_OFF
HI258_write_cmos_sensor(0x92, 0x78); //BLC_AG_TH_ON
HI258_write_cmos_sensor(0x93, 0x70); //BLC_AG_TH_OFF
...
HI258_write_cmos_sensor(0xd4, 0x0e); //DCDC_TIME_TH_ON
HI258_write_cmos_sensor(0xd5, 0x0e); //DCDC_TIME_TH_OFF 
HI258_write_cmos_sensor(0xd6, 0x78); //DCDC_AG_TH_ON
HI258_write_cmos_sensor(0xd7, 0x70); //DCDC_AG_TH_OFF
...
HI258_write_cmos_sensor(0x84, 0xd1); 
HI258_write_cmos_sensor(0x85, 0x40); 
HI258_write_cmos_sensor(0x86, 0x01); //EXPMin 11428.57 fps
HI258_write_cmos_sensor(0x87, 0xf4); 
HI258_write_cmos_sensor(0x88, 0x0c); //EXP Max 60hz 7.50 fps 
HI258_write_cmos_sensor(0x89, 0xf8); 
HI258_write_cmos_sensor(0x8a, 0x30); 
HI258_write_cmos_sensor(0xa5, 0x0c); //EXP Max 50hz 7.69 fps 
HI258_write_cmos_sensor(0xa6, 0xd1); 
HI258_write_cmos_sensor(0xa7, 0x42); 
HI258_write_cmos_sensor(0x8B, 0xea); //EXP100 
HI258_write_cmos_sensor(0x8C, 0x60); 
HI258_write_cmos_sensor(0x8D, 0xc3); //EXP120 
HI258_write_cmos_sensor(0x8E, 0x50); 
HI258_write_cmos_sensor(0x9c, 0x23); //EXP Limit 816.33 fps 
...
HI258_write_cmos_sensor(0xa4, 0xc3); 
...
void HI258_night_mode(kal_bool enable)	
{
    ...
    if (enable) 
    {
        ...
        if (HI258_Banding_setting == AE_FLICKER_MODE_50HZ) 
        {
            ...
            HI258_write_cmos_sensor(0x83, 0x12); //EXP Normal 33.33 fps 
            HI258_write_cmos_sensor(0x84, 0x4f); 
            HI258_write_cmos_sensor(0x85, 0x80); 
            HI258_write_cmos_sensor(0x86, 0x01); //EXPMin 6500.00 fps
            HI258_write_cmos_sensor(0x87, 0xf4); 
		          //EXP Max 60hz
            HI258_write_cmos_sensor(0x88, 0x12); //EXP Max 5 fps
            HI258_write_cmos_sensor(0x89, 0xf4);
            HI258_write_cmos_sensor(0x8a, 0x80);

			        //EXP Max 50hz
            HI258_write_cmos_sensor(0xa5, 0x12); //EXP Max 5 fps
            HI258_write_cmos_sensor(0xa6, 0x4f);
            HI258_write_cmos_sensor(0xa7, 0x80);
    ...
    else 
    {
        ...
        if (HI258_Banding_setting == AE_FLICKER_MODE_50HZ)
        {
            ...
            HI258_write_cmos_sensor(0x83, 0x0a); //EXP Normal 33.33 fps
            HI258_write_cmos_sensor(0x84, 0xfc);
            HI258_write_cmos_sensor(0x85, 0x80);
            HI258_write_cmos_sensor(0x86, 0x01); //EXPMin 6500.00 fps
            HI258_write_cmos_sensor(0x87, 0xf4);
		          //EXP Max 60hz
            HI258_write_cmos_sensor(0x88, 0x08); //EXP Max 8.33 fps
            HI258_write_cmos_sensor(0x89, 0x71);
            HI258_write_cmos_sensor(0x8a, 0xb0);

			        //EXP Max 50hz
            HI258_write_cmos_sensor(0xa5, 0x0a); //EXP Max 8.33 fps
            HI258_write_cmos_sensor(0xa6, 0xfc);
            HI258_write_cmos_sensor(0xa7, 0x80);
        ...
        else
        {
            ...
            HI258_write_cmos_sensor(0x84, 0x71);
            HI258_write_cmos_sensor(0x85, 0xb0);
            HI258_write_cmos_sensor(0x86, 0x01); //EXPMin 6500.00 fps
            HI258_write_cmos_sensor(0x87, 0xf4);
		          //EXP Max 60hz
            HI258_write_cmos_sensor(0x88, 0x0b); //EXP Max 8.33 fps
            HI258_write_cmos_sensor(0x89, 0x71);
            HI258_write_cmos_sensor(0x8a, 0xb0);
...
{	
    ...
    HI258_write_cmos_sensor(0x9c, 0x23); //EXP Limit 1083.33fps 
    HI258_write_cmos_sensor(0x9d, 0x28); 
    HI258_write_cmos_sensor(0x9e, 0x01); //EXP Unit 
    HI258_write_cmos_sensor(0x9f, 0xf4); 
