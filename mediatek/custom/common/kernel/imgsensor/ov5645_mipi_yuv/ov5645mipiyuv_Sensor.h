...
#define OV5645MIPI_IMAGE_SENSOR_QSXGA_WITDH        (2592) 
#define OV5645MIPI_IMAGE_SENSOR_QSXGA_HEIGHT       (1944)

/* Sesnor Pixel/Line Numbers in One Period */	
#define OV5645MIPI_PV_PERIOD_PIXEL_NUMS    		(1896)  		/* Default preview line length */
#define OV5645MIPI_PV_PERIOD_LINE_NUMS     		(984)   	/* Default preview frame length */
#define OV5645MIPI_FULL_PERIOD_PIXEL_NUMS  		(3052)  	/* Default full size line length */
...
#define OV5645MIPI_PV_GRAB_START_X 				(1)
#define OV5645MIPI_PV_GRAB_START_Y  			(1)
#define OV5645MIPI_PV_GRAB_WIDTH				(OV5645MIPI_IMAGE_SENSOR_720P_WIDTH - 8)
#define OV5645MIPI_PV_GRAB_HEIGHT				(OV5645MIPI_IMAGE_SENSOR_720P_HEIGHT - 6)

#define OV5645MIPI_FULL_GRAB_START_X   			(1)
#define OV5645MIPI_FULL_GRAB_START_Y	  		(1)
#define OV5645MIPI_FULL_GRAB_WIDTH				(OV5645MIPI_IMAGE_SENSOR_QSXGA_WITDH - 16)
#define OV5645MIPI_FULL_GRAB_HEIGHT				(OV5645MIPI_IMAGE_SENSOR_QSXGA_HEIGHT - 12)
...
/*
void OV5645MIPIWriteShutter(kal_uint32 shutter);
void OV5645MIPIWriteSensorGain(kal_uint32 gain);
void OV5645MIPISetDummy(kal_uint32 dummy_pixels, kal_uint32 dummy_lines);
UINT32 OV5645MIPIReadShutter(void);
UINT32 OV5645MIPIReadSensorGain(void);
