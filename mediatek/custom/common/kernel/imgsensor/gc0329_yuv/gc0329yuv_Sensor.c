...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x77, 0x60);
	GC0329_write_cmos_sensor(0x78, 0x40);
	GC0329_write_cmos_sensor(0x79, 0x54);
	...
	GC0329_write_cmos_sensor(0x33, 0x1c);
	GC0329_write_cmos_sensor(0x34, 0x1c);
	GC0329_write_cmos_sensor(0x35, 0x1c);
	GC0329_write_cmos_sensor(0x36, 0x1c);
	...
	GC0329_write_cmos_sensor(0xb5, 0x05);//02
	GC0329_write_cmos_sensor(0xb6, 0xfa);
	GC0329_write_cmos_sensor(0xb7, 0x44);//48
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x24);//38 betty  //2d 38
	GC0329_write_cmos_sensor(0xd2, 0x24);//2d 38
	GC0329_write_cmos_sensor(0xd3, 0x35);//2d//0x3a
	GC0329_write_cmos_sensor(0xdd, 0x54);

	////////////////////AEC////////////////////
	GC0329_SET_PAGE1;
	GC0329_write_cmos_sensor(0x10, 0x40);
	GC0329_write_cmos_sensor(0x11, 0x11);
	GC0329_write_cmos_sensor(0x12, 0x17);
	GC0329_write_cmos_sensor(0x13, 0x50);//50 betty 56
	GC0329_write_cmos_sensor(0x17, 0x88);
	GC0329_write_cmos_sensor(0x21, 0xb0);//b0  0903
	GC0329_write_cmos_sensor(0x22, 0x48);//48  0903
	...
	GC0329_write_cmos_sensor(0x08, 0x18);

	GC0329_SET_PAGE1;
	GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
	GC0329_write_cmos_sensor(0x2a, 0x60);   //anti-flicker step [7:0]

	GC0329_write_cmos_sensor(0x2b, 0x03);   //exp level 0  10fps   //3c0
	GC0329_write_cmos_sensor(0x2c, 0x00); 
	GC0329_write_cmos_sensor(0x2d, 0x03);   //exp level 1  10fps   //3c0
	GC0329_write_cmos_sensor(0x2e, 0xc0); 
	GC0329_write_cmos_sensor(0x2f, 0x04);   //exp level 2  7.69fps   //4e0
	GC0329_write_cmos_sensor(0x30, 0xe0); 
	GC0329_write_cmos_sensor(0x31, 0x07);   //exp level 3  5fps   //780
	...
	GC0329_write_cmos_sensor(0x51, 0x28);//20 betty
	GC0329_write_cmos_sensor(0x52, 0x08);//0b betty
	GC0329_write_cmos_sensor(0x53, 0x30);
	GC0329_write_cmos_sensor(0x54, 0x50);
	GC0329_write_cmos_sensor(0x55, 0x10);
	GC0329_write_cmos_sensor(0x56, 0x30);//20 betty
	...
	GC0329_write_cmos_sensor(0x5d, 0x76);
	...
	GC0329_write_cmos_sensor(0x6c, 0x10);
	GC0329_write_cmos_sensor(0x6d, 0x18);
	GC0329_write_cmos_sensor(0x6e, 0x41);
	GC0329_write_cmos_sensor(0x70, 0x18);
...
void GC0329_Write_More_Registers(void)
{
	...
	GC0329_write_cmos_sensor(0xd1,0x24);//34																																																																									
	GC0329_write_cmos_sensor(0xd2,0x24);//34
///////////////////////////////////////////////
	GC0329_write_cmos_sensor(0x1f,0xc8);																																																																									
	GC0329_write_cmos_sensor(0xfe,0x00);	
	///////////////////////////////////////////////
    	GC0329GammaSelect(GC0329_RGB_Gamma_m4);//0:use default//m5
}
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->PreviewDelayFrame = 3;//0 betty
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x06, 0x6a); 
			GC0329_write_cmos_sensor(0x07, 0x00);
			GC0329_write_cmos_sensor(0x08, 0x70);
			
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329_write_cmos_sensor(0x2a, 0x4b);   //anti-flicker step [7:0]
			
			GC0329_write_cmos_sensor(0x2b, 0x02);   //exp level 0  10fps   //3c0
			GC0329_write_cmos_sensor(0x2c, 0x58); 
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 1  10fps   //3c0
			GC0329_write_cmos_sensor(0x2e, 0xee); 
			GC0329_write_cmos_sensor(0x2f, 0x03);   //exp level 2  7.69fps   //4e0
			GC0329_write_cmos_sensor(0x30, 0x84); 
			GC0329_write_cmos_sensor(0x31, 0x04);   //exp level 3  5fps   //780
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x06, 0x6a); 
			GC0329_write_cmos_sensor(0x07, 0x00);
			GC0329_write_cmos_sensor(0x08, 0x4b);
			
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329_write_cmos_sensor(0x2a, 0x3f);   //anti-flicker step [7:0]
			
			GC0329_write_cmos_sensor(0x2b, 0x02);   //exp level 0  15.00fps
			GC0329_write_cmos_sensor(0x2c, 0x71); 
			GC0329_write_cmos_sensor(0x2d, 0x02);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0xee); 
			GC0329_write_cmos_sensor(0x2f, 0x03);   //exp level 0  10.00fps  //52e
			GC0329_write_cmos_sensor(0x30, 0xf0); 
			GC0329_write_cmos_sensor(0x31, 0x04);   //exp level 0  7.05fps   //618
			GC0329_write_cmos_sensor(0x32, 0xa4); 
			#else
			GC0329_write_cmos_sensor(0x05, 0x02); 	
			GC0329_write_cmos_sensor(0x06, 0x2c); 
			GC0329_write_cmos_sensor(0x07, 0x01);
			GC0329_write_cmos_sensor(0x08, 0x38);
			
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329_write_cmos_sensor(0x2a, 0x50);   //anti-flicker step [7:0]
			
			GC0329_write_cmos_sensor(0x2b, 0x03);   //exp level 0  15.00fps
			GC0329_write_cmos_sensor(0x2c, 0x20); 
			GC0329_write_cmos_sensor(0x2d, 0x03);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0xc0); 
			GC0329_write_cmos_sensor(0x2f, 0x05);   //exp level 0  10.00fps  //52e
			GC0329_write_cmos_sensor(0x30, 0x00); 
			GC0329_write_cmos_sensor(0x31, 0x07);   //exp level 0  7.05fps   //618
			GC0329_write_cmos_sensor(0x32, 0x80); 
			#endif
			GC0329_SET_PAGE0;
		break;
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_luma = (GC0329_NIGHT_MODE?0x00:0x00);//0x00
	value_Y = (GC0329_NIGHT_MODE?0x50:0x50);//0x68,0x50 sarah
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			printk("gc0329------%s=0 \n",__FUNCTION__);
			GC0329_write_cmos_sensor(0xd5, value_luma  + 0x04);//value_luma
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, value_Y  + 0x04);//value_Y
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_07:
			GC0329_write_cmos_sensor(0xd5, value_luma + 0x28);
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, value_Y + 0x28);
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_10:
			GC0329_write_cmos_sensor(0xd5, value_luma + 0x30);//0x30
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, value_Y + 0x30);//0x30
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;
...
{
	printk("[GC0329SetTestPatternMode]leanda test pattern bEnable:=%d\n",bEnable);
	if(bEnable)
	{		
		
		GC0329_write_cmos_sensor(0xfe, 0x00); 
		GC0329_write_cmos_sensor(0xfe, 0x00); 
		GC0329_write_cmos_sensor(0x18, 0x06); //sdark
		GC0329_write_cmos_sensor(0x40, 0x08); //only intp enable
		GC0329_write_cmos_sensor(0x41, 0x00); //close all
		GC0329_write_cmos_sensor(0x42, 0x00); //close all
		GC0329_write_cmos_sensor(0x4f, 0x00); //add
		GC0329_write_cmos_sensor(0x77, 0x40); //AWB gain
		GC0329_write_cmos_sensor(0x78, 0x40); //AWB gain
		GC0329_write_cmos_sensor(0x79, 0x40); //AWB gain
		GC0329_write_cmos_sensor(0xd0, 0x40); //asde saturation
		GC0329_write_cmos_sensor(0xdd, 0x00); //AEC un
		GC0329_write_cmos_sensor(0x03, 0x00); //
		GC0329_write_cmos_sensor(0x04, 0x01); //
		GC0329_write_cmos_sensor(0x71, 0x40); //AEC gain
		GC0329_write_cmos_sensor(0x72, 0x40); //AEC gain
		GC0329_write_cmos_sensor(0xfe, 0x01); //ABS tilt
		GC0329_write_cmos_sensor(0x9e, 0xc0); //ABS tilt
		GC0329_write_cmos_sensor(0x9f, 0x40); //ABS stretch K
		GC0329_write_cmos_sensor(0xfe, 0x00); //ABS stretch K
		GC0329_write_cmos_sensor(0x4c, 0x01); //test pattern
	...
	else
	{
		...
		GC0329_write_cmos_sensor(0x9f, 0x40); //ABS stretch K
		GC0329_write_cmos_sensor(0xfe, 0x00); //ABS stretch K
		GC0329_write_cmos_sensor(0x4c, 0x00); //test pattern
	}
	return ERROR_NONE;
}
