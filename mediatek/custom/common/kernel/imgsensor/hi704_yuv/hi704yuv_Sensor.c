...
//extern void SubCameraDigtalPDNCtrl(u32 onoff);	//LINE <> <20130822> <resolve the Bug that can't change to subCamera on little phones> panzaoyan
...
//    HI704_write_cmos_sensor(0x18, HI704_read_cmos_sensor(0x18)|0x08);   //Reset AE
    ...
    //HI704_write_cmos_sensor(0x83, 0x02);
    //HI704_write_cmos_sensor(0x84, 0xf9);
    //HI704_write_cmos_sensor(0x85, 0xb8);
    HI704_write_cmos_sensor(0x86, 0x00);
    HI704_write_cmos_sensor(0x87, 0xfa);

    HI704_write_cmos_sensor(0x8b, 0x1f);
    HI704_write_cmos_sensor(0x8c, 0xbd);
    HI704_write_cmos_sensor(0x8d, 0x1a);
    HI704_write_cmos_sensor(0x8e, 0x5e);
...
static void HI704_Cal_Min_Frame_Rate(kal_uint16 min_framerate)
{
    ...
    if(HI704_sensor.banding == AE_FLICKER_MODE_50HZ)
    {
        ...
        HI704_expmax = HI704_expbanding*10*(100/min_framerate) ;
    }
    else if(HI704_sensor.banding == AE_FLICKER_MODE_60HZ)
    {
        ...
        HI704_expmax = HI704_expbanding*10*(120/min_framerate) ;
    }
    else//default 5oHZ
    {
...
{
    SENSORDB("HHL[Enter]HI704 night mode func:enable = %d\n",enable);
...

{
  if (HI704_sensor.banding == AE_FLICKER_MODE_50HZ) 
  {
	...
	SENSORDB("[HI704]HI704NightMode Disable AE_FLICKER_MODE_50HZ\n");
  ...
  HI704_write_cmos_sensor(0x83, 0x02);
  HI704_write_cmos_sensor(0x84, 0x7a);
  HI704_write_cmos_sensor(0x85, 0xc4);
  HI704_write_cmos_sensor(0x86, 0x00);
  HI704_write_cmos_sensor(0x87, 0xfa);
  
  HI704_write_cmos_sensor(0x88, 0x02);
  HI704_write_cmos_sensor(0x89, 0x7a);
  HI704_write_cmos_sensor(0x8A, 0xc4);//7
  ...
  else
  {
		...
		HI704_write_cmos_sensor(0x83, 0x02);
		HI704_write_cmos_sensor(0x84, 0x78);
		HI704_write_cmos_sensor(0x85, 0xd0);
		HI704_write_cmos_sensor(0x86, 0x00);
		HI704_write_cmos_sensor(0x87, 0xfa);
		
		HI704_write_cmos_sensor(0x88, 0x02);
		HI704_write_cmos_sensor(0x89, 0x78);
		HI704_write_cmos_sensor(0x8A, 0xd0);//7
...
{
  if (HI704_sensor.banding == AE_FLICKER_MODE_50HZ) 
  { 	SENSORDB("[HI704]HI704NightMode Enable AE_FLICKER_MODE_50HZ\n");
  HI704_write_cmos_sensor(0x03, 0x20);
  
  HI704_write_cmos_sensor(0x10, HI704_read_cmos_sensor(0x10)&0x7f);   //Close AE
  HI704_write_cmos_sensor(0x18, HI704_read_cmos_sensor(0x18)|0x08);   //Reset AE
  
  //HI704_write_cmos_sensor(0x83, 0x01);
  //HI704_write_cmos_sensor(0x84, 0xbc);
  //HI704_write_cmos_sensor(0x85, 0x56);
  HI704_write_cmos_sensor(0x86, 0x00);
  HI704_write_cmos_sensor(0x87, 0xfa);
  
  HI704_write_cmos_sensor(0x88, 0x01);
  HI704_write_cmos_sensor(0x89, 0xbc);
  HI704_write_cmos_sensor(0x8A, 0x56);//7
  ...
  { 	SENSORDB("[HI704]HI704NightMode Enable AE_FLICKER_MODE_60HZ\n");
  ...
  //HI704_write_cmos_sensor(0x83, 0x01);
  //HI704_write_cmos_sensor(0x84, 0xc0);
  //HI704_write_cmos_sensor(0x85, 0x3e);
  HI704_write_cmos_sensor(0x86, 0x00);
  HI704_write_cmos_sensor(0x87, 0xfa);
  
  HI704_write_cmos_sensor(0x88, 0x01);
  HI704_write_cmos_sensor(0x89, 0xc0);
  HI704_write_cmos_sensor(0x8A, 0x3e);//7
...
/*
   ...
   if(HI704_sensor.first_init == KAL_TRUE)
    ...
    SENSORDB("HHL[Enter]:HI704 preview func:");		
    SENSORDB("HI704_sensor.video_mode = %d\n",HI704_sensor.MPEG4_Video_mode); 
 ...
 HI704_write_cmos_sensor(0x21, 0x05);
 HI704_write_cmos_sensor(0x90, 0x07);
 HI704_write_cmos_sensor(0x91, 0x05);
  HI704_write_cmos_sensor(0x03, 0x10);
 HI704_write_cmos_sensor(0x48, 0x88);
...
UINT32 HI704Capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    SENSORDB("HHL[HI704][Enter]HI704_capture_func\n");
    spin_lock(&hi704_yuv_drv_lock);
...
UINT32 HI704Control(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow,
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    SENSORDB("HHL [Enter]:HI704 Control func:ScenarioId = %d\n",ScenarioId);
...
BOOL HI704_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_AUTO:
        ...
        HI704_write_cmos_sensor(0x83, 0x4e);
        ...
        HI704_write_cmos_sensor(0x10, 0xfb);	
          ...
          // HI704_write_cmos_sensor(0x01, 0x90);
        }                
        break;
    case AWB_MODE_CLOUDY_DAYLIGHT:
    {
        ...
        HI704_write_cmos_sensor(0x10, 0xfb);
        //   HI704_write_cmos_sensor(0x01, 0x70);
    ...
    case AWB_MODE_DAYLIGHT:
       ...
       HI704_write_cmos_sensor(0x03, 0x22);
        ...
        HI704_write_cmos_sensor(0x10, 0xfb);
          // HI704_write_cmos_sensor(0x01, 0xb0);
        }      
        break;
    case AWB_MODE_INCANDESCENT:	
       ...
       HI704_write_cmos_sensor(0x03, 0x22);
        ...
        HI704_write_cmos_sensor(0x10, 0xfb);
         //  HI704_write_cmos_sensor(0x01, 0xd0);
        }		
        break;  
    ...
    case AWB_MODE_TUNGSTEN:
       ...
       HI704_write_cmos_sensor(0x03, 0x22);
        ...
        HI704_write_cmos_sensor(0x10, 0xfb);
               //HI704_write_cmos_sensor(0x01, 0x50);
        }
        break;
    case AWB_MODE_OFF:
        {
...
BOOL HI704_set_param_effect(UINT16 para)
{
   SENSORDB("[Enter]HI704 set_param_effect func:para = %d\n",para);
    ...
    case MEFFECT_OFF:
        ...
        HI704_write_cmos_sensor(0x13, 0x03);
...
BOOL HI704_set_param_banding(UINT16 para)
{
    ...
    case AE_FLICKER_MODE_50HZ:
		...
		HI704_write_cmos_sensor(0x88, 0x01);
		HI704_write_cmos_sensor(0x89, 0xbc);
		HI704_write_cmos_sensor(0x8A, 0x56);//50HZ
    ...
    case AE_FLICKER_MODE_60HZ:
		...
		HI704_write_cmos_sensor(0x88, 0x01);
		HI704_write_cmos_sensor(0x89, 0xc0);
		HI704_write_cmos_sensor(0x8A, 0x3e);//60HZ
...
BOOL HI704_set_param_exposure(UINT16 para)
{
    ...
    case AE_EV_COMP_00:  // +0 EV
        HI704_write_cmos_sensor(0x40,0x8a);
        break;    
...
{/*
    ...
    spin_unlock(&hi704_yuv_drv_lock);
        ...
        HI704_Fix_Video_Frame_Rate(100); 
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    SENSORDB("HHL [Enter]:HI704 Feature Control func:FeatureId = %d\n",FeatureId);
