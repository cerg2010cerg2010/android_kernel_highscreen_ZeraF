...
void OV2685_MIPI_globle_init(void)
{
    ...
    OV2685_MIPI_write_cmos_sensor(0x3501,0x24); //54
    OV2685_MIPI_write_cmos_sensor(0x3502,0x30); //30
    ...
    OV2685_MIPI_write_cmos_sensor(0x3820,0xc6);//c2
    ...
    OV2685_MIPI_write_cmos_sensor(0x3a02,0x91);
    OV2685_MIPI_write_cmos_sensor(0x3a00,0x43);
    OV2685_MIPI_write_cmos_sensor(0x382a,0x09);
    
    OV2685_MIPI_write_cmos_sensor(0x3a06,0x0 );
    OV2685_MIPI_write_cmos_sensor(0x3a07,0xC9);
    OV2685_MIPI_write_cmos_sensor(0x3a08,0x0 );
    OV2685_MIPI_write_cmos_sensor(0x3a09,0xA7);    
    OV2685_MIPI_write_cmos_sensor(0x3a0e,0x7 );
    OV2685_MIPI_write_cmos_sensor(0x3a0f,0xDA);
    OV2685_MIPI_write_cmos_sensor(0x3a10,0x7 );
    OV2685_MIPI_write_cmos_sensor(0x3a11,0xD4);
    OV2685_MIPI_write_cmos_sensor(0x3a0a,0x7 );
    OV2685_MIPI_write_cmos_sensor(0x3a0b,0xDA);
    OV2685_MIPI_write_cmos_sensor(0x3a0c,0x7 );
    OV2685_MIPI_write_cmos_sensor(0x3a0d,0xD4);
    ...
    OV2685_MIPI_write_cmos_sensor(0x5002,0x33); //32//33
    ...
    OV2685_MIPI_write_cmos_sensor(0x5606,0x20); //24
    OV2685_MIPI_write_cmos_sensor(0x5605,0x00); //10

    
    OV2685_MIPI_write_cmos_sensor(0x0100,0x01);
    
    OV2685_MIPI_write_cmos_sensor(0x5180,0xf4);//f4             
    ...
    OV2685_MIPI_write_cmos_sensor(0x5184,0x7c);//78             
    OV2685_MIPI_write_cmos_sensor(0x5185,0x53);//52             
    OV2685_MIPI_write_cmos_sensor(0x5186,0x8a);//86             
    OV2685_MIPI_write_cmos_sensor(0x5187,0x95);//a6             
    OV2685_MIPI_write_cmos_sensor(0x5188,0xd );//0c             
    OV2685_MIPI_write_cmos_sensor(0x5189,0x16);//0e             
    OV2685_MIPI_write_cmos_sensor(0x518a,0x13);//0d             
    OV2685_MIPI_write_cmos_sensor(0x518b,0x4c);//4f             
    OV2685_MIPI_write_cmos_sensor(0x518c,0x30);//3c             
    ...
    OV2685_MIPI_write_cmos_sensor(0x5195,0x5 );//05             
    OV2685_MIPI_write_cmos_sensor(0x5196,0x42);//a7             
    OV2685_MIPI_write_cmos_sensor(0x5197,0x4 );//04             
    OV2685_MIPI_write_cmos_sensor(0x5198,0x0 );//00             
    OV2685_MIPI_write_cmos_sensor(0x5199,0x7 );//06             
    OV2685_MIPI_write_cmos_sensor(0x519a,0xf8);//ac             
    OV2685_MIPI_write_cmos_sensor(0x519b,0x10);//04             
    ...
    OV2685_MIPI_write_cmos_sensor(0x530a,0x26);
    ...
    */
    OV2685_MIPI_write_cmos_sensor(0x5400,0x0d);
    OV2685_MIPI_write_cmos_sensor(0x5401,0x1a);
    OV2685_MIPI_write_cmos_sensor(0x5402,0x32);
    OV2685_MIPI_write_cmos_sensor(0x5403,0x59);
    OV2685_MIPI_write_cmos_sensor(0x5404,0x68);
    OV2685_MIPI_write_cmos_sensor(0x5405,0x76);
    OV2685_MIPI_write_cmos_sensor(0x5406,0x82);
    OV2685_MIPI_write_cmos_sensor(0x5407,0x8c);
    ...
    OV2685_MIPI_write_cmos_sensor(0x540f,0xa0);
    OV2685_MIPI_write_cmos_sensor(0x5410,0x6e);
    OV2685_MIPI_write_cmos_sensor(0x5411,0x06);
    ...
    OV2685_MIPI_write_cmos_sensor(0x5600,0x02);
    ...
    OV2685_MIPI_write_cmos_sensor(0x5801,0x18);//F5     
    OV2685_MIPI_write_cmos_sensor(0x5802,0x02);//02     
    OV2685_MIPI_write_cmos_sensor(0x5803,0x59);//4E     
    OV2685_MIPI_write_cmos_sensor(0x5804,0x15);//3C     
    OV2685_MIPI_write_cmos_sensor(0x5805,0x05);//05     
    OV2685_MIPI_write_cmos_sensor(0x5806,0x54);//1A     
    OV2685_MIPI_write_cmos_sensor(0x5807,0x05);//05     
    OV2685_MIPI_write_cmos_sensor(0x5808,0x03);//03     
    OV2685_MIPI_write_cmos_sensor(0x5809,0x26);//09     
    OV2685_MIPI_write_cmos_sensor(0x580A,0x02);//02     
    OV2685_MIPI_write_cmos_sensor(0x580B,0x5B);//4A     
    OV2685_MIPI_write_cmos_sensor(0x580C,0x12);//37     
    OV2685_MIPI_write_cmos_sensor(0x580D,0x05);//05     
    OV2685_MIPI_write_cmos_sensor(0x580E,0x37);//8C     
    OV2685_MIPI_write_cmos_sensor(0x580F,0x05);//05     
    OV2685_MIPI_write_cmos_sensor(0x5810,0x03);//02     
    OV2685_MIPI_write_cmos_sensor(0x5811,0x0D);//F1     
    OV2685_MIPI_write_cmos_sensor(0x5812,0x02);//02     
    OV2685_MIPI_write_cmos_sensor(0x5813,0x5C);//4B     
    OV2685_MIPI_write_cmos_sensor(0x5814,0x0E);//2C     
    OV2685_MIPI_write_cmos_sensor(0x5815,0x05);//05     
    OV2685_MIPI_write_cmos_sensor(0x5816,0x3B);//1E     
    ...
    OV2685_MIPI_write_cmos_sensor(0x3a03,0x54); //50
    OV2685_MIPI_write_cmos_sensor(0x3a04,0x44); //40
...
void OV2685_MIPI_night_mode(kal_bool enable)
{
	  kal_uint8 night = OV2685_MIPI_read_cmos_sensor(0x3a00); 
		...
		if (OV2685_MIPI_sensor_cap_state == KAL_FALSE) 
		{
			if (enable) 
			{
			  if (OV2685_MIPI_VEDIO_encode_mode == KAL_TRUE) 
				...
				else 
				{
					  /* Camera mode only */	
            OV2685_MIPI_write_cmos_sensor(0x3a06, 0x0 );
            OV2685_MIPI_write_cmos_sensor(0x3a07, 0xD1);
            OV2685_MIPI_write_cmos_sensor(0x3a08, 0x0 );
            OV2685_MIPI_write_cmos_sensor(0x3a09, 0xAE);          
            OV2685_MIPI_write_cmos_sensor(0x3a0e, 0xF );
            OV2685_MIPI_write_cmos_sensor(0x3a0f, 0x83);
            OV2685_MIPI_write_cmos_sensor(0x3a10, 0xF );
            OV2685_MIPI_write_cmos_sensor(0x3a11, 0xA2);							                                  
						OV2685_MIPI_write_cmos_sensor(0x3a0a, 0xF );
						OV2685_MIPI_write_cmos_sensor(0x3a0b, 0x83);
						OV2685_MIPI_write_cmos_sensor(0x3a0c, 0xF );
						OV2685_MIPI_write_cmos_sensor(0x3a0d, 0xA2);
            ...
            OV2685_MIPI_write_cmos_sensor(0x3a08, 0x0 );
            OV2685_MIPI_write_cmos_sensor(0x3a09, 0xAE);          
            OV2685_MIPI_write_cmos_sensor(0x3a0e, 0x2 );
            OV2685_MIPI_write_cmos_sensor(0x3a0f, 0x73);
            OV2685_MIPI_write_cmos_sensor(0x3a10, 0x2 );
            OV2685_MIPI_write_cmos_sensor(0x3a11, 0xB8);	 
						OV2685_MIPI_write_cmos_sensor(0x3a0a, 0x7 ); //78c //64a 
						OV2685_MIPI_write_cmos_sensor(0x3a0b, 0x59); 
						OV2685_MIPI_write_cmos_sensor(0x3a0c, 0x8 ); //78c
						OV2685_MIPI_write_cmos_sensor(0x3a0d, 0x28);
	  ...
	  volatile signed char i;
		...
		mDELAY(10);		
			...
			for(i=0;i<3;i++)
			{
				...
				if(sensor_id == 0x2685)
				{
					SENSORDB("++++OV2685_MIPI_GetSensorID,read id = 0x%x OK\n", sensor_id);
                    			break;                    
				}
			}
            if(0x2685 == sensor_id)
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  kal_uint16 iDummyPixels = 0, iDummyLines = 0, iStartX = 0, iStartY = 0;
    ...
    OV2685_MIPI_write_cmos_sensor(0x380d,0xac);
    OV2685_MIPI_write_cmos_sensor(0x380e,0x02);
    OV2685_MIPI_write_cmos_sensor(0x380f,0xb8); //84);
    ...
    OV2685_MIPI_write_cmos_sensor(0x3a0f,0x73);
    OV2685_MIPI_write_cmos_sensor(0x3a10,0x2 );
    OV2685_MIPI_write_cmos_sensor(0x3a11,0xB8);//max=30fps, min=10fps  
    OV2685_MIPI_write_cmos_sensor(0x3a0a,0x7 );
		OV2685_MIPI_write_cmos_sensor(0x3a0b,0x59);
		OV2685_MIPI_write_cmos_sensor(0x3a0c,0x8 );
		OV2685_MIPI_write_cmos_sensor(0x3a0d,0x28);    
    ...
    if(sensor_config_data->SensorOperationMode==MSDK_SENSOR_OPERATION_MODE_VIDEO)		// MPEG4 Encode Mode
    {
        ...
        //OV2685_MIPI_write_cmos_sensor(0x3a0a, 0x2 );
        //OV2685_MIPI_write_cmos_sensor(0x3a0b, 0x5B);
        //OV2685_MIPI_write_cmos_sensor(0x3a0c, 0x2 );
        //OV2685_MIPI_write_cmos_sensor(0x3a0d, 0x9C);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
 ...
 //if(OV2685_MIPI_sensor_cap_state = KAL_FALSE)
 {
    ...
    kal_uint32 temp_reg,temp_reg_gain;
 		kal_uint8  P_gain;
   ...
   // OV2685_MIPI_write_cmos_sensor(0x3a00, temp_reg&0xfd); //Disable night mode  
    ...
    P_gain = OV2685_MIPI_read_cmos_sensor(0x350b)& 0xff;
    ...
    shutter = OV2685_MIPI_read_shutter();
		SENSORDB("[OV2685MIPI]OV2685Capture++++++++++++,Gain=%d or 0x%x\n ", P_gain,P_gain);
		SENSORDB("[OV2685MIPI]OV2685Capture++++++++++++,exposure=%d  or 0x%x\n", OV2685_MIPI_exposure_line_h,OV2685_MIPI_exposure_line_h );
		SENSORDB("[OV2685MIPI]OV2685Capture++++++++++++,exposure=%d  or 0x%x\n", OV2685_MIPI_exposure_line_m,OV2685_MIPI_exposure_line_m );
		SENSORDB("[OV2685MIPI]OV2685Capture++++++++++++,exposure=%d  or 0x%x\n", OV2685_MIPI_exposure_line_l,OV2685_MIPI_exposure_line_l );
    ...
    {    
        ...
        OV2685_MIPI_write_cmos_sensor(0x380c,0x06); //6ac //6c0
        OV2685_MIPI_write_cmos_sensor(0x380d,0xac); //a4
        OV2685_MIPI_write_cmos_sensor(0x380e,0x0f); //5); 10fps
        OV2685_MIPI_write_cmos_sensor(0x380f,0xb0); //0e);
        ...
        OV2685_MIPI_write_cmos_sensor(0x5606,0x24); //24
	    OV2685_MIPI_write_cmos_sensor(0x5605,0x10); //10
	
        if (P_gain >= 0x80) 
        {  
				OV2685_MIPI_write_cmos_sensor(0x5607,0x0c);
				OV2685_MIPI_write_cmos_sensor(0x5608,0x08);           
        }
        else
        {
				OV2685_MIPI_write_cmos_sensor(0x5607,0x08);
				OV2685_MIPI_write_cmos_sensor(0x5608,0x08); 
        }
		...
		OV2685_MIPI_write_cmos_sensor(0x3820, 0xc4);
		OV2685_MIPI_write_cmos_sensor(0x3821, 0x04); 
       	spin_lock(&ov2685_drv_lock);
...
{
    SENSORDB("[OV2685MIPI]enter OV2685MIPI_get_AEAWB_lock function:\n ");
    *pAElockRet32 =1;
    *pAWBlockRet32=1;
    SENSORDB("[OV2685MIPI]OV2685MIPI_get_AEAWB_lock,AE=%d,AWB=%d\n",*pAElockRet32,*pAWBlockRet32);
    SENSORDB("[OV2685MIPI]exit OV2685MIPI_get_AEAWB_lock function:\n ");
}

void OV2685_3ACtrl(ACDK_SENSOR_3A_LOCK_ENUM action)
{
    SENSORDB("[OV2685MIPI]enter ACDK_SENSOR_3A_LOCK_ENUM function:action=%d\n",action);
    switch (action)
    {
    ...
    case SENSOR_3A_AE_UNLOCK:
        ...
        spin_unlock(&ov2685_drv_lock);
        OV2685_MIPI_set_AE_mode(KAL_TRUE);
        break;
    case SENSOR_3A_AWB_LOCK:
        spin_lock(&ov2685_drv_lock);
        //OV2685MIPISensor.userAskAwbLock = TRUE;
        spin_unlock(&ov2685_drv_lock);
        OV2685_MIPI_set_AWB_mode(KAL_FALSE);
        break;
    ...
    SENSORDB("[OV2685MIPI]exit ACDK_SENSOR_3A_LOCK_ENUM function:action=%d\n",action);
    return;
}
...
BOOL OV2685_MIPI_set_param_wb(UINT16 para)
{
    ...
    switch (para)
    {
        ...
        case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
            ...
            OV2685_MIPI_write_cmos_sensor(0x5195, 0x07); 
            OV2685_MIPI_write_cmos_sensor(0x5196, 0xdc);
        ...
        case AWB_MODE_DAYLIGHT: //sunny
            ...
            OV2685_MIPI_write_cmos_sensor(0x5180, temp_reg|0x02); 
            OV2685_MIPI_write_cmos_sensor(0x5195, 0x07); 
            OV2685_MIPI_write_cmos_sensor(0x5196, 0x9c);
            OV2685_MIPI_write_cmos_sensor(0x5197, 0x04);  
            OV2685_MIPI_write_cmos_sensor(0x5198, 0x00); 
            OV2685_MIPI_write_cmos_sensor(0x5199, 0x05);
        ...
        case AWB_MODE_INCANDESCENT: //office
            ...
            OV2685_MIPI_write_cmos_sensor(0x5196, 0xb8);
            OV2685_MIPI_write_cmos_sensor(0x5197, 0x04);  
            OV2685_MIPI_write_cmos_sensor(0x5198, 0x00); 
            OV2685_MIPI_write_cmos_sensor(0x5199, 0x06);
            OV2685_MIPI_write_cmos_sensor(0x519a, 0x5f); 
...
BOOL OV2685_MIPI_set_param_exposure(UINT16 para)
{
    ...
    switch (para)
    {
        case AE_EV_COMP_n20:
            ...
            OV2685_MIPI_write_cmos_sensor(0x3a03, 0x1a);
            OV2685_MIPI_write_cmos_sensor(0x3a04, 0x10);
        ...
        case AE_EV_COMP_n10:    
            ...
            OV2685_MIPI_write_cmos_sensor(0x3a03, 0x32);
            OV2685_MIPI_write_cmos_sensor(0x3a04, 0x28);
        ...
        case AE_EV_COMP_00:
            ...
            OV2685_MIPI_write_cmos_sensor(0x3a03, 0x54);
            OV2685_MIPI_write_cmos_sensor(0x3a04, 0x44);
        ...
        case AE_EV_COMP_10:
            ...
            OV2685_MIPI_write_cmos_sensor(0x3a03, 0x62);
            OV2685_MIPI_write_cmos_sensor(0x3a04, 0x58);
        ...
        case AE_EV_COMP_20:
            ...
            OV2685_MIPI_write_cmos_sensor(0x3a03, 0x7a);
            OV2685_MIPI_write_cmos_sensor(0x3a04, 0x70);
...
UINT32 OV2685MIPIYUVSetVideoMode(UINT16 u2FrameRate)
{
    ...
    if (u2FrameRate == 30)
    {
		    ...
		    OV2685_MIPI_write_cmos_sensor(0x3a11,0xB8);//  
		    OV2685_MIPI_write_cmos_sensor(0x3a0a,0x2 );
				OV2685_MIPI_write_cmos_sensor(0x3a0b,0x73);
				OV2685_MIPI_write_cmos_sensor(0x3a0c,0x2 );
				OV2685_MIPI_write_cmos_sensor(0x3a0d,0xB8);                              
    }                                            
    ...
    {                                            
      ...
      // OV2685_MIPI_write_cmos_sensor(0x380f, 0x38); //08);                                        
      //                                         
      // OV2685_MIPI_write_cmos_sensor(0x3a06, 0x0 );
      // OV2685_MIPI_write_cmos_sensor(0x3a07, 0xC9);
      // OV2685_MIPI_write_cmos_sensor(0x3a08, 0x0 );
      // OV2685_MIPI_write_cmos_sensor(0x3a09, 0xA7);        
      // OV2685_MIPI_write_cmos_sensor(0x3a0e, 0x4 );
      // OV2685_MIPI_write_cmos_sensor(0x3a0f, 0xB6);
      // OV2685_MIPI_write_cmos_sensor(0x3a10, 0x4 );
      // OV2685_MIPI_write_cmos_sensor(0x3a11, 0x91);                                   
      // OV2685_MIPI_write_cmos_sensor(0x3a0a, 0x4 );
			//OV2685_MIPI_write_cmos_sensor(0x3a0b, 0xB6);
			// OV2685_MIPI_write_cmos_sensor(0x3a0c, 0x4 );
			//OV2685_MIPI_write_cmos_sensor(0x3a0d, 0x91);    
    }
    else 
    {
...
//		       SENSORDB("OV2685 MIPI YUV sensor Setting:%d, %d \n", *pFeatureData32,  *(pFeatureData32+1));
		...
		case SENSOR_FEATURE_SET_YUV_3A_CMD:
    		OV2685_3ACtrl((ACDK_SENSOR_3A_LOCK_ENUM)*pFeatureData32);
        break;
		case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
				SENSORDB("[OV2685MIPI]SENSOR_FEATURE_GET_AF_STATUS\n");
