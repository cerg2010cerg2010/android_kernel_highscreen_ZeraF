...
#define GC2145_TEST_PATTERN_CHECKSUM    0x00

  #define GC2145MIPI_Full_Preview
...
UINT32 GC2145SetTestPatternMode(kal_bool bEnable)
{
         ...
         {                
                   ...
                   GC2145MIPI_write_cmos_sensor(0x18, 0x02); //sdark
                   GC2145MIPI_write_cmos_sensor(0x80, 0x08); //only intp enable
                   GC2145MIPI_write_cmos_sensor(0x81, 0x00); //close all
                   GC2145MIPI_write_cmos_sensor(0x82, 0x00); //close all
                   GC2145MIPI_write_cmos_sensor(0x87, 0x00); //close all
                   GC2145MIPI_write_cmos_sensor(0xb6, 0x00); //AEC_dis
                   GC2145MIPI_write_cmos_sensor(0xb3, 0x40); //AWB gain
                   GC2145MIPI_write_cmos_sensor(0xb4, 0x40); //AWB gain
                   GC2145MIPI_write_cmos_sensor(0xb5, 0x40); //AWB gain
                   ...
                   GC2145MIPI_write_cmos_sensor(0xd3, 0x40); //asde saturation
                   GC2145MIPI_write_cmos_sensor(0xd5, 0x00); 
                   GC2145MIPI_write_cmos_sensor(0xd8, 0x00); 
                   GC2145MIPI_write_cmos_sensor(0xdd, 0x00); //edge_sa
                   GC2145MIPI_write_cmos_sensor(0xde, 0x00); 
                   GC2145MIPI_write_cmos_sensor(0xed, 0x00); 
                   GC2145MIPI_write_cmos_sensor(0xfe, 0x00); //
                   GC2145MIPI_write_cmos_sensor(0x03, 0x00); //
                   GC2145MIPI_write_cmos_sensor(0x04, 0x01); //
                   GC2145MIPI_write_cmos_sensor(0xb1, 0x40); //AEC gain
                   GC2145MIPI_write_cmos_sensor(0xb2, 0x40); //AEC gain
                   GC2145MIPI_write_cmos_sensor(0x25, 0x01);
                   GC2145MIPI_write_cmos_sensor(0xfe, 0x01); //
                   GC2145MIPI_write_cmos_sensor(0x9e, 0xc0); //ABS tilt
                   GC2145MIPI_write_cmos_sensor(0x9f, 0x40); //ABS stretch K
                   GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
                   GC2145MIPI_write_cmos_sensor(0x8c, 0x01); //test pattern
         }
         else
         {
             			GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
...
void GC2145MIPI_night_mode(kal_bool enable)
{
		...
		if (GC2145MIPI_sensor_cap_state == KAL_FALSE) 
		{
			if (enable) 
			{
				...
				{
					GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
					GC2145MIPI_write_cmos_sensor(0x3c, 0x00);
					GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
				}
				else 
				{
...

{
	...
	*sensorID=((GC2145MIPI_read_cmos_sensor(0xf0) << 8) | GC2145MIPI_read_cmos_sensor(0xf1));	
	 if (*sensorID == GC2145MIPI_SENSOR_ID)
            break; 
...
static void GC2145MIPI_Sensor_Init(void)
{
	...
	GC2145MIPI_write_cmos_sensor(0x17, 0x17);  // 14
	GC2145MIPI_write_cmos_sensor(0x18, 0x22);
	GC2145MIPI_write_cmos_sensor(0x19, 0x0e);//0f
	...
	GC2145MIPI_write_cmos_sensor(0x86, 0x06);
	GC2145MIPI_write_cmos_sensor(0x88, 0x03);
	GC2145MIPI_write_cmos_sensor(0x89, 0x03);
	GC2145MIPI_write_cmos_sensor(0x85, 0x04);
	...
	///////////  BLK ////////////////////////
	///////////////////////////////////////////////
	//GC2145MIPI_write_cmos_sensor(0x18, 0x02);
	GC2145MIPI_write_cmos_sensor(0x40, 0x42);
	GC2145MIPI_write_cmos_sensor(0x41, 0x00);
	GC2145MIPI_write_cmos_sensor(0x43, 0x58);
	...
	GC2145MIPI_write_cmos_sensor(0x6a, 0x00);//02
	GC2145MIPI_write_cmos_sensor(0x6b, 0x00);//02
	GC2145MIPI_write_cmos_sensor(0x6c, 0x3e);//02
	GC2145MIPI_write_cmos_sensor(0x6d, 0x3e);//02
	GC2145MIPI_write_cmos_sensor(0x6e, 0x3f);//02
	GC2145MIPI_write_cmos_sensor(0x6f, 0x3f);//02
	GC2145MIPI_write_cmos_sensor(0x70, 0x00);//02
	GC2145MIPI_write_cmos_sensor(0x71, 0x00);
	GC2145MIPI_write_cmos_sensor(0x76, 0x00);
	...
	///////////////////////////////////////////////
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0x01, 0x08);
	GC2145MIPI_write_cmos_sensor(0x02, 0xc0);
	GC2145MIPI_write_cmos_sensor(0x03, 0x04);
	GC2145MIPI_write_cmos_sensor(0x04, 0x90);
	GC2145MIPI_write_cmos_sensor(0x05, 0x30);
	GC2145MIPI_write_cmos_sensor(0x06, 0x98);
	GC2145MIPI_write_cmos_sensor(0x07, 0x28);
	GC2145MIPI_write_cmos_sensor(0x08, 0x6c);
	GC2145MIPI_write_cmos_sensor(0x09, 0x00);
	GC2145MIPI_write_cmos_sensor(0x0a, 0xc2);
	GC2145MIPI_write_cmos_sensor(0x0b, 0x11);
	GC2145MIPI_write_cmos_sensor(0x0c, 0x10);
	//GC2145MIPI_write_cmos_sensor(0x11, 0x10);//outdoor slope
	GC2145MIPI_write_cmos_sensor(0x13, 0x2a);
	GC2145MIPI_write_cmos_sensor(0x17, 0x00);
	GC2145MIPI_write_cmos_sensor(0x1c, 0x11);
	GC2145MIPI_write_cmos_sensor(0x1e, 0x61);
	GC2145MIPI_write_cmos_sensor(0x1f, 0x30);
	GC2145MIPI_write_cmos_sensor(0x20, 0x40);
	GC2145MIPI_write_cmos_sensor(0x22, 0x80);
	GC2145MIPI_write_cmos_sensor(0x23, 0x20);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x02);
	GC2145MIPI_write_cmos_sensor(0x0f, 0x05);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0x12, 0x30);
	GC2145MIPI_write_cmos_sensor(0x15, 0x50);
	GC2145MIPI_write_cmos_sensor(0x10, 0x31);
	GC2145MIPI_write_cmos_sensor(0x3e, 0x28);
	GC2145MIPI_write_cmos_sensor(0x3f, 0xe0);
	GC2145MIPI_write_cmos_sensor(0x40, 0xe0);
	GC2145MIPI_write_cmos_sensor(0x41, 0x08);
	...
	GC2145MIPI_write_cmos_sensor(0x82, 0x05);//08
	GC2145MIPI_write_cmos_sensor(0x83, 0x08);//05
	GC2145MIPI_write_cmos_sensor(0x84, 0x0a);
	GC2145MIPI_write_cmos_sensor(0x86, 0xf0);//50
	GC2145MIPI_write_cmos_sensor(0x87, 0x50);//30
	GC2145MIPI_write_cmos_sensor(0x88, 0x15);
	GC2145MIPI_write_cmos_sensor(0x89, 0x50);//80
	GC2145MIPI_write_cmos_sensor(0x8a, 0x30);//60
	GC2145MIPI_write_cmos_sensor(0x8b, 0x10);//30
	...
	GC2145MIPI_write_cmos_sensor(0xb7, 0x02);
	GC2145MIPI_write_cmos_sensor(0xb9, 0x28);
	GC2145MIPI_write_cmos_sensor(0x3c, 0x08);
	GC2145MIPI_write_cmos_sensor(0x3d, 0x20);
	GC2145MIPI_write_cmos_sensor(0x4b, 0x08);
	...
	*/
	...
	///////////////////////////////////////////////  
	GC2145MIPI_write_cmos_sensor(0xfe , 0x02);
	GC2145MIPI_write_cmos_sensor(0xd1 , 0x36);//32
	GC2145MIPI_write_cmos_sensor(0xd2 , 0x36);//32
	GC2145MIPI_write_cmos_sensor(0xd3 , 0x44);
	...
	GC2145MIPI_write_cmos_sensor(0xed , 0x81);
	GC2145MIPI_write_cmos_sensor(0xee , 0x3f);
	...
	GC2145MIPI_write_cmos_sensor(0xa4, 0x77);
	GC2145MIPI_write_cmos_sensor(0xa5, 0x77);
	GC2145MIPI_write_cmos_sensor(0xa6, 0x77);
	GC2145MIPI_write_cmos_sensor(0xa7, 0x67);
	GC2145MIPI_write_cmos_sensor(0xa8, 0x77);
	GC2145MIPI_write_cmos_sensor(0xa9, 0x77);
	GC2145MIPI_write_cmos_sensor(0xaa, 0x10);
	GC2145MIPI_write_cmos_sensor(0xab, 0x0a);
	GC2145MIPI_write_cmos_sensor(0xac, 0x15);
	GC2145MIPI_write_cmos_sensor(0xad, 0x0f);
	GC2145MIPI_write_cmos_sensor(0xae, 0x0a);
	GC2145MIPI_write_cmos_sensor(0xaf, 0x11);
	GC2145MIPI_write_cmos_sensor(0xb0, 0x10);
	GC2145MIPI_write_cmos_sensor(0xb1, 0x0d);
	GC2145MIPI_write_cmos_sensor(0xb2, 0x14);
	GC2145MIPI_write_cmos_sensor(0xb3, 0x0f);
	GC2145MIPI_write_cmos_sensor(0xb4, 0x09);
	GC2145MIPI_write_cmos_sensor(0xb5, 0x09);
	GC2145MIPI_write_cmos_sensor(0xb6, 0x4c);
	GC2145MIPI_write_cmos_sensor(0xb7, 0x34);
	GC2145MIPI_write_cmos_sensor(0xb8, 0x2d);
	GC2145MIPI_write_cmos_sensor(0xb9, 0x28);
	GC2145MIPI_write_cmos_sensor(0xba, 0x17);
	GC2145MIPI_write_cmos_sensor(0xbb, 0x0e);
	GC2145MIPI_write_cmos_sensor(0xbc, 0x50);
	GC2145MIPI_write_cmos_sensor(0xbd, 0x50);
	GC2145MIPI_write_cmos_sensor(0xbe, 0x46);
	GC2145MIPI_write_cmos_sensor(0xbf, 0x32);
	GC2145MIPI_write_cmos_sensor(0xc0, 0x3c);
	GC2145MIPI_write_cmos_sensor(0xc1, 0x35);
	GC2145MIPI_write_cmos_sensor(0xc2, 0x2b);
	GC2145MIPI_write_cmos_sensor(0xc3, 0x23);
	GC2145MIPI_write_cmos_sensor(0xc4, 0x1b);
	GC2145MIPI_write_cmos_sensor(0xc5, 0x10);
	GC2145MIPI_write_cmos_sensor(0xc6, 0x04);
	GC2145MIPI_write_cmos_sensor(0xc7, 0x07);
	GC2145MIPI_write_cmos_sensor(0xc8, 0x32);
	GC2145MIPI_write_cmos_sensor(0xc9, 0x24);
	GC2145MIPI_write_cmos_sensor(0xca, 0x2b);
	GC2145MIPI_write_cmos_sensor(0xcb, 0x1c);
	GC2145MIPI_write_cmos_sensor(0xcc, 0x0e);
	GC2145MIPI_write_cmos_sensor(0xcd, 0x2b);
	GC2145MIPI_write_cmos_sensor(0xd0, 0x25);
	GC2145MIPI_write_cmos_sensor(0xd1, 0x35);
	GC2145MIPI_write_cmos_sensor(0xd2, 0x11);
	GC2145MIPI_write_cmos_sensor(0xd3, 0x3c);
	GC2145MIPI_write_cmos_sensor(0xd4, 0x38);
	GC2145MIPI_write_cmos_sensor(0xd5, 0x27);
	GC2145MIPI_write_cmos_sensor(0xd6, 0x1d);
	GC2145MIPI_write_cmos_sensor(0xd7, 0x35);
	GC2145MIPI_write_cmos_sensor(0xd8, 0x05);
	GC2145MIPI_write_cmos_sensor(0xd9, 0x27);
	GC2145MIPI_write_cmos_sensor(0xda, 0x2a);
	GC2145MIPI_write_cmos_sensor(0xdb, 0x0e);
	
	GC2145MIPI_write_cmos_sensor(0xfe , 0x01);
	GC2145MIPI_write_cmos_sensor(0xdf , 0x0d);
	GC2145MIPI_write_cmos_sensor(0xdc , 0x25); // 25 
	GC2145MIPI_write_cmos_sensor(0xdd , 0x50); // 50
  ...
  GC2145MIPI_write_cmos_sensor(0xfe , 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x4d , 0x50);
	GC2145MIPI_write_cmos_sensor(0x4e , 0x02);
	GC2145MIPI_write_cmos_sensor(0x4c , 0x01);
	GC2145MIPI_write_cmos_sensor(0x4d , 0x70);
	GC2145MIPI_write_cmos_sensor(0x4e , 0x02);
	GC2145MIPI_write_cmos_sensor(0x4c , 0x01);
	GC2145MIPI_write_cmos_sensor(0x4d , 0x4f);
	GC2145MIPI_write_cmos_sensor(0x4e , 0x02);
	GC2145MIPI_write_cmos_sensor(0x4c , 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x4e , 0x03);
	GC2145MIPI_write_cmos_sensor(0x4c , 0x01);
	GC2145MIPI_write_cmos_sensor(0x4d , 0xec);
	GC2145MIPI_write_cmos_sensor(0x4e , 0x03);
	GC2145MIPI_write_cmos_sensor(0x4c , 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x4e , 0x00);
	GC2145MIPI_write_cmos_sensor(0x4c , 0x02);
	GC2145MIPI_write_cmos_sensor(0x4d , 0x87);
	...
	GC2145MIPI_write_cmos_sensor(0x52 , 0x57);//18.7%?
	GC2145MIPI_write_cmos_sensor(0x54 , 0x38);
	GC2145MIPI_write_cmos_sensor(0x55 , 0xc7);
	...
	GC2145MIPI_write_cmos_sensor(0x61 , 0xd3);
	GC2145MIPI_write_cmos_sensor(0x62 , 0x90);
	GC2145MIPI_write_cmos_sensor(0x63 , 0x04);
	GC2145MIPI_write_cmos_sensor(0x65 , 0x04);
	GC2145MIPI_write_cmos_sensor(0x67 , 0xb2);
	GC2145MIPI_write_cmos_sensor(0x68 , 0xac);
	GC2145MIPI_write_cmos_sensor(0x69 , 0x00);
	GC2145MIPI_write_cmos_sensor(0x6a , 0xb2);
	GC2145MIPI_write_cmos_sensor(0x6b , 0xac);
	GC2145MIPI_write_cmos_sensor(0x6c , 0xdc);
	GC2145MIPI_write_cmos_sensor(0x6d , 0xb0);
	GC2145MIPI_write_cmos_sensor(0x6e , 0x30);
	GC2145MIPI_write_cmos_sensor(0x6f , 0x50);
	GC2145MIPI_write_cmos_sensor(0x70 , 0x05); 
	GC2145MIPI_write_cmos_sensor(0x71 , 0x80); 
	GC2145MIPI_write_cmos_sensor(0x72 , 0x80); 
	GC2145MIPI_write_cmos_sensor(0x73 , 0x30); 
	GC2145MIPI_write_cmos_sensor(0x74 , 0x01); 
	GC2145MIPI_write_cmos_sensor(0x75 , 0x01); 
	GC2145MIPI_write_cmos_sensor(0x7f , 0x08);
	GC2145MIPI_write_cmos_sensor(0x76 , 0x70); 
	GC2145MIPI_write_cmos_sensor(0x77 , 0x48); 
	...
	GC2145MIPI_write_cmos_sensor(0xC1 , 0x48);
	GC2145MIPI_write_cmos_sensor(0xc2 , 0xF8);
	GC2145MIPI_write_cmos_sensor(0xc3 , 0x04);
	GC2145MIPI_write_cmos_sensor(0xc4 , 0xF0);
	GC2145MIPI_write_cmos_sensor(0xc5 , 0x4B);
	GC2145MIPI_write_cmos_sensor(0xc6 , 0xFD);
	GC2145MIPI_write_cmos_sensor(0xc7 , 0x50);
	GC2145MIPI_write_cmos_sensor(0xc8 , 0xf2);
	GC2145MIPI_write_cmos_sensor(0xc9 , 0x00);
	...
	GC2145MIPI_write_cmos_sensor(0x28, 0xe2);
	GC2145MIPI_write_cmos_sensor(0x29, 0x06);
	GC2145MIPI_write_cmos_sensor(0x2a, 0xd6);
	GC2145MIPI_write_cmos_sensor(0x2b, 0x07);
	GC2145MIPI_write_cmos_sensor(0x2c, 0xd0);
	GC2145MIPI_write_cmos_sensor(0x2d, 0x0b);
	GC2145MIPI_write_cmos_sensor(0x2e, 0xb8);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	...
	GC2145MIPI_write_cmos_sensor(0x01, 0x07);
	GC2145MIPI_write_cmos_sensor(0x02, 0x22);
	GC2145MIPI_write_cmos_sensor(0x03, 0x10);
	GC2145MIPI_write_cmos_sensor(0x04, 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x15, 0x12);
	GC2145MIPI_write_cmos_sensor(0x17, 0xf0);
	
	GC2145MIPI_write_cmos_sensor(0x21, 0x01);
	GC2145MIPI_write_cmos_sensor(0x22, 0x02);
	GC2145MIPI_write_cmos_sensor(0x23, 0x01);
	GC2145MIPI_write_cmos_sensor(0x24, 0x10);
	GC2145MIPI_write_cmos_sensor(0x29, 0x02);
	GC2145MIPI_write_cmos_sensor(0x2a, 0x03);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
}
...
static void GC2145MIPI_Sensor_SVGA(void)
{
	...
	GC2145MIPI_write_cmos_sensor(0xf7, 0x35);
	...
	//// AWB                     
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	GC2145MIPI_write_cmos_sensor(0xec, 0x01);
	...
	GC2145MIPI_write_cmos_sensor(0x06, 0x4c);
	GC2145MIPI_write_cmos_sensor(0x07, 0x14);
	GC2145MIPI_write_cmos_sensor(0x08, 0x36);
	GC2145MIPI_write_cmos_sensor(0x0a, 0xc0);
	GC2145MIPI_write_cmos_sensor(0x21, 0x14);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	//// mipi
	GC2145MIPI_write_cmos_sensor(0xfe, 0x03);
...
static void GC2145MIPI_Sensor_2M(void)
{
	...
	//// AWB                   
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	GC2145MIPI_write_cmos_sensor(0xec, 0x02); //06
	GC2145MIPI_write_cmos_sensor(0xed, 0x04);
	GC2145MIPI_write_cmos_sensor(0xee, 0x60);
	GC2145MIPI_write_cmos_sensor(0xef, 0x90);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	...
	//// AEC                    
	GC2145MIPI_write_cmos_sensor(0xfe, 0x01);
	GC2145MIPI_write_cmos_sensor(0x01, 0x08);//04
	GC2145MIPI_write_cmos_sensor(0x02, 0xc0);
	GC2145MIPI_write_cmos_sensor(0x03, 0x04);
	GC2145MIPI_write_cmos_sensor(0x04, 0x90);
	GC2145MIPI_write_cmos_sensor(0x05, 0x30);
	GC2145MIPI_write_cmos_sensor(0x06, 0x98);
	GC2145MIPI_write_cmos_sensor(0x07, 0x28);//40
	GC2145MIPI_write_cmos_sensor(0x08, 0x6c);//80
	GC2145MIPI_write_cmos_sensor(0x0a, 0xc2);
	GC2145MIPI_write_cmos_sensor(0x21, 0x04);
	GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
	//// mipi
...
UINT32 GC2145MIPIOpen(void)
{
	...
	for(i=0;i<3;i++)
	{
		...
		if (sensor_id != GC2145MIPI_SENSOR_ID)
		return ERROR_SENSOR_CONNECT_FAIL;
	}
...
#ifdef GC2145MIPI_Full_Preview
	pSensorResolution->SensorPreviewWidth=GC2145MIPI_IMAGE_SENSOR_FULL_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X;
	pSensorResolution->SensorPreviewHeight=GC2145MIPI_IMAGE_SENSOR_FULL_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y;
	pSensorResolution->SensorVideoWidth=GC2145MIPI_IMAGE_SENSOR_FULL_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X;
	pSensorResolution->SensorVideoHeight=GC2145MIPI_IMAGE_SENSOR_FULL_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y;
#else
...
{
#ifdef GC2145MIPI_Full_Preview
	pSensorInfo->SensorPreviewResolutionX=GC2145MIPI_IMAGE_SENSOR_FULL_WIDTH;
	pSensorInfo->SensorPreviewResolutionY=GC2145MIPI_IMAGE_SENSOR_FULL_HEIGHT;
#else
...
BOOL GC2145MIPI_set_param_wb(UINT16 para)
{
	...
	{
		case AWB_MODE_AUTO:
			GC2145MIPI_write_cmos_sensor(0xb3, 0x61);
			GC2145MIPI_write_cmos_sensor(0xb4, 0x40);
			GC2145MIPI_write_cmos_sensor(0xb5, 0x61);
...
BOOL GC2145MIPI_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2145MIPI_write_cmos_sensor(0x27, 0x04);
		GC2145MIPI_write_cmos_sensor(0x28, 0xe0);
		GC2145MIPI_write_cmos_sensor(0x29, 0x06);
		GC2145MIPI_write_cmos_sensor(0x2a, 0x80);
		GC2145MIPI_write_cmos_sensor(0x2b, 0x08);
		GC2145MIPI_write_cmos_sensor(0x2c, 0x20);
		GC2145MIPI_write_cmos_sensor(0x2d, 0x0b);
		GC2145MIPI_write_cmos_sensor(0x2e, 0x60);
		GC2145MIPI_write_cmos_sensor(0xfe, 0x00);
            break;
...
BOOL GC2145MIPI_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		case AE_EV_COMP_n13:
			...
			GC2145MIPI_write_cmos_sensor(0x13,0x10);
			GC2145MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_n10:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0x15);
			GC2145MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_n07:
			GC2145MIPI_SET_PAGE1;
		...
		case AE_EV_COMP_n03:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0x25);
			GC2145MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_00:
			GC2145MIPI_SET_PAGE1;
		...
		case AE_EV_COMP_03:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0x35);
			GC2145MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_07:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0x40);
			GC2145MIPI_SET_PAGE0;
		break;
		case AE_EV_COMP_10:
			GC2145MIPI_SET_PAGE1;
		...
		case AE_EV_COMP_13:
			GC2145MIPI_SET_PAGE1;
			GC2145MIPI_write_cmos_sensor(0x13,0x50);
			GC2145MIPI_SET_PAGE0;
		break;
		default:
		return FALSE;
...
UINT32 GC2145MIPIYUVSensorSetting(FEATURE_ID iCmd, UINT32 iPara)
{
...
UINT32 GC2145MIPIYUVSetVideoMode(UINT16 u2FrameRate)
{
    kal_uint8 iTemp;
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_NIGHTMODE:
			GC2145MIPI_night_mode((BOOL) *pFeatureData16);
		break;
		...
		case SENSOR_FEATURE_SET_YUV_CMD:
			...
			GC2145MIPIYUVSensorSetting((FEATURE_ID)*pFeatureData32, *(pFeatureData32+1));
		break;
		case SENSOR_FEATURE_SET_VIDEO_MODE:
		       GC2145MIPIYUVSetVideoMode(*pFeatureData16);
		       break;
		case SENSOR_FEATURE_SET_TEST_PATTERN:
			GC2145SetTestPatternMode((BOOL)*pFeatureData16);
			break;
