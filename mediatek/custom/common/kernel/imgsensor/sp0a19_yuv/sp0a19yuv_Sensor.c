...
u8 SP0A19_Initialize_from_T_Flash()
{
	...
	i++;
	//for (j=0; j<i; j++)
	//printk(" %x  ==  %x\n",SP0A19_Init_Reg[j].init_reg, SP0A19_Init_Reg[j].init_val);
...
//Status
 ...
 //lsc  for st
   SP0A19_write_cmos_sensor(0xfd,0x01);
   SP0A19_write_cmos_sensor(0x35,0x17);
   SP0A19_write_cmos_sensor(0x36,0x15);
   SP0A19_write_cmos_sensor(0x37,0x15);
   SP0A19_write_cmos_sensor(0x38,0x10);
   SP0A19_write_cmos_sensor(0x39,0x14);
   SP0A19_write_cmos_sensor(0x3a,0x15);
   SP0A19_write_cmos_sensor(0x3b,0x13);
   SP0A19_write_cmos_sensor(0x3c,0x13);
   SP0A19_write_cmos_sensor(0x3d,0x18);
   SP0A19_write_cmos_sensor(0x3e,0x14);
   SP0A19_write_cmos_sensor(0x3f,0x16);
   SP0A19_write_cmos_sensor(0x40,0x16);
   SP0A19_write_cmos_sensor(0x41,0x00);
   SP0A19_write_cmos_sensor(0x42,0x07);
   SP0A19_write_cmos_sensor(0x43,0x00);
   SP0A19_write_cmos_sensor(0x44,0x00);
   SP0A19_write_cmos_sensor(0x45,0x00);
   SP0A19_write_cmos_sensor(0x46,0x00);
   SP0A19_write_cmos_sensor(0x47,0xfa);
   SP0A19_write_cmos_sensor(0x48,0x00);
   SP0A19_write_cmos_sensor(0x49,0xfa);
   SP0A19_write_cmos_sensor(0x4a,0xfd);
   SP0A19_write_cmos_sensor(0x4b,0x00);
   SP0A19_write_cmos_sensor(0x4c,0xfa);
   SP0A19_write_cmos_sensor(0xfd,0x00);  
//awb 1
   SP0A19_write_cmos_sensor(0xfd,0x01);
...
//d65
   SP0A19_write_cmos_sensor(0x65,0xcc);//d5
   SP0A19_write_cmos_sensor(0x66,0xec);//fa
   SP0A19_write_cmos_sensor(0x67,0x70);//72
   SP0A19_write_cmos_sensor(0x68,0x98);//8a
//indoor
   SP0A19_write_cmos_sensor(0x69,0x83);//c6
   SP0A19_write_cmos_sensor(0x6a,0xa6);//ee
   SP0A19_write_cmos_sensor(0x6b,0xa6);//94
   SP0A19_write_cmos_sensor(0x6c,0xd5);//ab
//f
   SP0A19_write_cmos_sensor(0x61,0x80);//7a
   SP0A19_write_cmos_sensor(0x62,0x9e);//98
   SP0A19_write_cmos_sensor(0x63,0xc0);//c5
   SP0A19_write_cmos_sensor(0x64,0xe0);//e6
//cwf
  SP0A19_write_cmos_sensor(0x6d,0xa8);//b9
  SP0A19_write_cmos_sensor(0x6e,0xcb);//de
  SP0A19_write_cmos_sensor(0x6f,0xa6);//b2
  SP0A19_write_cmos_sensor(0x70,0xc8);//d5
...
//smooth
   ...
   SP0A19_write_cmos_sensor(0x58,0x0c); //raw_dif_thr_normal
   SP0A19_write_cmos_sensor(0x56,0x0e); //raw_dif_thr_dummy
   SP0A19_write_cmos_sensor(0x59,0x12); //raw_dif_thr_lowlight
	//GrGb平滑阈值
   SP0A19_write_cmos_sensor(0x89,0x08);	//raw_grgb_thr_outdoor 
   SP0A19_write_cmos_sensor(0x8a,0x0c); //raw_grgb_thr_normal  
   SP0A19_write_cmos_sensor(0x9c,0x0e); //raw_grgb_thr_dummy   
   SP0A19_write_cmos_sensor(0x9d,0x12); //raw_grgb_thr_lowlight
...
//sharpen 
   ...
   SP0A19_write_cmos_sensor(0xe5,0x08); //rangek_neg_outdoor
   SP0A19_write_cmos_sensor(0xd3,0x08); //rangek_pos_outdoor   
   SP0A19_write_cmos_sensor(0xd7,0x08); //range_base_outdoor   
  
   SP0A19_write_cmos_sensor(0xe6,0x0a); //rangek_neg_normal
   SP0A19_write_cmos_sensor(0xd4,0x0a); //rangek_pos_normal 
   SP0A19_write_cmos_sensor(0xd8,0x0a); //range_base_normal  
   ...
   SP0A19_write_cmos_sensor(0xd2,0x15); //rangek_neg_lowlight
   SP0A19_write_cmos_sensor(0xd6,0x15); //rangek_pos_lowlight
   SP0A19_write_cmos_sensor(0xda,0x15); //range_base_lowlight
  
   SP0A19_write_cmos_sensor(0xe8,0x20);//sharp_fac_pos_outdoor
   SP0A19_write_cmos_sensor(0xec,0x2c);//sharp_fac_neg_outdoor
   SP0A19_write_cmos_sensor(0xe9,0x20);//sharp_fac_pos_nr
   SP0A19_write_cmos_sensor(0xed,0x2c);//sharp_fac_neg_nr
   SP0A19_write_cmos_sensor(0xea,0x18);//sharp_fac_pos_dummy
   SP0A19_write_cmos_sensor(0xef,0x1c);//sharp_fac_neg_dummy
   SP0A19_write_cmos_sensor(0xeb,0x15);//sharp_fac_pos_low
   SP0A19_write_cmos_sensor(0xf0,0x18);//sharp_fac_neg_low 
  
//CCM
   SP0A19_write_cmos_sensor(0xfd,0x01);
   SP0A19_write_cmos_sensor(0xa0,0x6c);//66//80(红色接近，肤色不理想)
   SP0A19_write_cmos_sensor(0xa1,0x06);//00//0 
   SP0A19_write_cmos_sensor(0xa2,0x0c);//19//0 
   SP0A19_write_cmos_sensor(0xa3,0xe7);//f3//f0
   SP0A19_write_cmos_sensor(0xa4,0x8c);//8e//a6
   SP0A19_write_cmos_sensor(0xa5,0x0c);//00//ea
   SP0A19_write_cmos_sensor(0xa6,0xfa);//00//0 
   SP0A19_write_cmos_sensor(0xa7,0xd4);//e6//e6
   SP0A19_write_cmos_sensor(0xa8,0xb3);//9a//9a
   SP0A19_write_cmos_sensor(0xa9,0x00);//00//0 
   SP0A19_write_cmos_sensor(0xaa,0x03);//03//33
   SP0A19_write_cmos_sensor(0xab,0x0f);//0c//c 
   SP0A19_write_cmos_sensor(0xfd,0x00);
  
//gamma  
  
  SP0A19_write_cmos_sensor(0xfd,0x00);
  SP0A19_write_cmos_sensor(0x8b,0x00);//00//0 
  SP0A19_write_cmos_sensor(0x8c,0x0a);//0c//11
  SP0A19_write_cmos_sensor(0x8d,0x19);//19//19 
  SP0A19_write_cmos_sensor(0x8e,0x2d);///2c//28 
  SP0A19_write_cmos_sensor(0x8f,0x4f);//49//46 
  SP0A19_write_cmos_sensor(0x90,0x6a);//61//61 
  SP0A19_write_cmos_sensor(0x91,0x86);//77//78 
  SP0A19_write_cmos_sensor(0x92,0x9b);//8a//8A 
  SP0A19_write_cmos_sensor(0x93,0xab);//9b//9B 
  SP0A19_write_cmos_sensor(0x94,0xb6);//a9//A9 
  SP0A19_write_cmos_sensor(0x95,0xbe);//b5//B5 
  SP0A19_write_cmos_sensor(0x96,0xc5);//c0//C0 
  SP0A19_write_cmos_sensor(0x97,0xcc);//ca//CA 
  SP0A19_write_cmos_sensor(0x98,0xd4);//d4//D4 
  SP0A19_write_cmos_sensor(0x99,0xdb);//dd//DD 
  SP0A19_write_cmos_sensor(0x9a,0xe3);//e6//E6 
  SP0A19_write_cmos_sensor(0x9b,0xeb);//ef//EF 
  SP0A19_write_cmos_sensor(0xfd,0x01);//01 
  SP0A19_write_cmos_sensor(0x8d,0xf5);//f7//F7 
  SP0A19_write_cmos_sensor(0x8e,0xff);//FF 
...
//gray detect
   ...
   SP0A19_write_cmos_sensor(0x4d,0x60);///2f//40
...
//saturation
   ...
   SP0A19_write_cmos_sensor(0xd3,0x8a);//0x78
   SP0A19_write_cmos_sensor(0xd4,0x8a);//0x78
   SP0A19_write_cmos_sensor(0xd6,0x7a);//0x78      
   SP0A19_write_cmos_sensor(0xd7,0x5a);//0x78
//HEQ
   SP0A19_write_cmos_sensor(0xfd,0x00);
   SP0A19_write_cmos_sensor(0xdc,0x00);
   SP0A19_write_cmos_sensor(0xdd,0x70);
   SP0A19_write_cmos_sensor(0xde,0x80);//80
...
UINT32 SP0A19GetSensorID(UINT32 *sensorID)
{
	...
	SENSORDB("Read Sensor ID OK sensor_id = 0x%x\n", sensor_id);
	if (sensor_id != SP0A19_SENSOR_ID) {
...
UINT32 SP0A19Open(void)
{
	...
	else 
	{
		...
		//SP0A19_Initialize_from_T_Flash();
