...
static void lcm_initialization_setting(void)
{
  ...
  data_array[3] = 0x28207412;//vrhp,vrhn 0x3028  0x2c247412
...
//MDELAY(1);
 ...
 // data_array[1] = 0x000880B4;//column inversion
  ...
  data_array[1] = 0x00A300B6; ///////////aa a3
  data_array[2] = 0x000000A3;
  dsi_set_cmdq(&data_array, 3, 1);
...
LCM_DRIVER hx8379a_wvga_dsi_vdo_m402_azrt_tn_lcm_drv = 
{
    .name   = "hx8379a_wvga_dsi_vdo_m402_azrt_tn",
