...
#ifndef _CAMERA_SENSOR_PARA_S5K5EAYX_YUV_GZ_H
#define _CAMERA_SENSOR_PARA_S5K5EAYX_YUV_GZ_H
...
typedef enum
{
	...
	/* STRUCT: SENSOR */
#define  S5K5EAYX_YUV_GZ_CAMERA_SENSOR_REG_DEFAULT_VALUE \
		/* ARRAY: SENSOR.reg[11] */\
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
...
#define  S5K5EAYX_YUV_GZ_CAMERA_SENSOR_CCT_DEFAULT_VALUE {{0x30a1,0x00},{0x3000,0x1B}}


#endif//#ifndef _CAMERA_SENSOR_PARA_S5K5EAYX_YUV_GZ_H
