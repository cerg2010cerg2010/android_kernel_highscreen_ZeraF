...
# AEON add 
  ifneq ($(AEON_EMMC),)
	$(hide) cp -f $(MTK_ROOT_CUSTOM)/$(PROJECT)/preloader/inc/custom_MemoryDevice_$(AEON_EMMC).h $(CUSTOM_MEMORY_HDR)
  else 
#	$(hide) cp -f $(MTK_ROOT_CUSTOM)/$(PROJECT)/preloader/inc/custom_MemoryDevice.h $(CUSTOM_MEMORY_HDR)
  endif
# add end
